...
public final class ResetChatNameEffect extends Effect {
    ...
    public static void bootstrap(JavaPlugin plugin, ChatNameService chatNameService) {
        ResetChatNameEffect.plugin = plugin;
        ResetChatNameEffect.chatNameService = chatNameService;
        Skript.registerEffect(ResetChatNameEffect.class,
    ...
    protected void execute(Event event) {
        ...
        chatNameService.resetChatName(target);
    }
